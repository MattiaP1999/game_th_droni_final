...
load("./data/pmd_pfa_rounds/workspa_pmd_pfa_1_2_4.mat")
...
legend('$\sigma_{\rm s}= 3, N=1$','$\sigma_{\rm s}= 10,N=1$','$\sigma_{\rm s}: 16,N=1$','$\sigma_{\rm s}= 3, N=2$','$\sigma_{\rm s}= 10,N=2$','$\sigma_{\rm s}: 16,N=2$','$\sigma_{\rm s}= 3, N=4$','$\sigma_{\rm s}= 10,N=4$','$\sigma_{\rm s}: 16,N=4$','interpreter','latex')
